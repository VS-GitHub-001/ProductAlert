...
{
    public class ProductsjjController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,ProductName,AboutProduct,ManufacturerDate,ExpiringDate,BatchNumber,Description,Consequency")] Product product)
        {
            if (ModelState.IsValid)
            {
